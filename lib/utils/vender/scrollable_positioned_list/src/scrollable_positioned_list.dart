...
class _ScrollablePositionedListState extends State<ScrollablePositionedList>
  ...
  void _jumpTo({@required int index, double offset = 0}) {
  ...
  Future<void> _scrollTo(
    ...
    if (cancelScrollCallback != null) {
      ...
      await _startScroll(
          index: index, offset: offset, duration: duration, curve: curve);
    }
  }
  ...
  Future<void> _startScroll(
    ...
    if (itemPosition != null) {
      final scrollAmount = itemPosition.itemLeadingEdge *
          startingScrollController.position.viewportDimension;
      var animateOffset =
          startingScrollController.offset + scrollAmount + offset;
      animateOffset =
      ...
      startAnimationCallback = () {
        SchedulerBinding.instance.addPostFrameCallback((_) async {
          ...
          startAnimationCallback = () {};
          // print("$_showBackList, $_showFrontList");
          var endJump = -direction *
              (_screenScrollCount *
                  startingScrollController.position.viewportDimension);
          var startScroll =
              startingScrollController.offset + direction * scrollAmount;
          print("endJump=$endJump, endScroll=0， startScroll=$startScroll");
